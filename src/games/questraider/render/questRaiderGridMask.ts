...
const MASK_URL = `${BASE}quest_raiders/mask.png`;

let cached: Texture | null | undefined;

/**
 * Authoring: bright green fill = visible reel window (see `public/quest_raiders/mask.png`).
...
export async function loadQuestRaiderGridMaskTexture(): Promise<Texture | null> {
